...
parser.add_argument('-o', '--optimizer', default='SGD', type=str, help="The optimizer can be only chosen from {\'SGD\', \'Adam\', \'AdamW\', \'double\'} for now. More may be implemented later")
...
if __name__ == "__main__":
    ...
    args.model_name = model_name[2]  # model name
    ...
    args.seed = 1 # seed
    args.epochs = 50 #
    args.optimizer = {1:'SGD', 2: 'Adam', 3:'AdamW', 4: 'double'}[4]
